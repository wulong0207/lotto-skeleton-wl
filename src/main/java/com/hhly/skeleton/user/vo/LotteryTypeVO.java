 ...
 * 彩种
 */
public class LotteryTypeVO extends BaseVO{
...
1-30为每5分钟一期，31-60为每10分钟一期；
    ...
    public void setShowSwitch (String showSwitch) {
    ...
    public String toString () {
        return "LotteryTypeVO{" +
                ...
                ", conIssueNum=" + conIssueNum +
                ", stopAddIssue=" + stopAddIssue +
                ", lotteryLogoUrl='" + lotteryLogoUrl + '\'' +
                ...
                ", startSailTime='" + startSailTime + '\'' +
                ", endSailTime='" + endSailTime + '\'' +
                ", sailDayCycle='" + sailDayCycle + '\'' +
                ", vacations='" + vacations + '\'' +
                ", createBy='" + createBy + '\'' +
                ", modifyBy='" + modifyBy + '\'' +
