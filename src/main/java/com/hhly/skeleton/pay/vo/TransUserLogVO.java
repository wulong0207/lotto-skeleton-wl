 ...
 * @version 1.0
 */
public class TransUserLogVO implements Serializable {
	...
	public TransUserLogVO() {
		super();
	}

	public TransUserLogVO(Integer userId, String orderCode, Short transType, Short transStatus) {
		super();
		this.userId = userId;
