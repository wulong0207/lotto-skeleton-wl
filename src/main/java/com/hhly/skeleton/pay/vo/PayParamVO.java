...
public class PayParamVO implements Serializable {
	...
	private Double buyAmount;// 参与合买的金额，2018-05-08添加，只有是合买订单才有值
	...
	public String getTransCode() {
		if(transCode!=null && transCode.contains("?")){
			transCode = transCode.substring(0,transCode.indexOf("?"));
		}
		return transCode;
	}
	...
	public String toString() {
		return "PayParamVO [orderCode=" + orderCode + ",buyAmount=" + buyAmount + ",redCode=" + redCode + ", token=" + token + ", platform=" + platform + ", balance=" + balance + ", payAmount=" + payAmount + ", bankId=" + bankId + ", bankCardId="
				+ bankCardId + ", returnUrl=" + returnUrl + ", remark=" + remark + ", extraData=" + extraData + ", buyType=" + buyType + ", isBatchPay=" + isBatchPay + ", channelId=" + channelId + ", change=" + change + ", openId=" + openId
				+ ", appId=" + appId + ", issueId=" + issueId + ", clientIp=" + clientIp + ", transCode=" + transCode + ", bankCode=" + bankCode + ", payBankcardBO=" + payBankcardBO + ", payBankBO=" + payBankBO + ", useRedAmount=" + useRedAmount
				+ ", useBalance=" + useBalance + ", orderQueryVoList=" + orderQueryVoList + ", userId=" + userId + ", endSaleTime=" + endSaleTime + ", activityAmount=" + activityAmount + ", activityCode=" + activityCode + ", isTest=" + isTest + "]";
	}
