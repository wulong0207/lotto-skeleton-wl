...
public class FuShiBetsContent implements Serializable {
	...
	//add by cheng.chen 17.10.19 用于数据转换
	public final static Map<String, Map<String, String>> fbPlayWay = new HashMap<String, Map<String, String>>();
	public final static Map<String, Map<String, String>> bbPlayWay = new HashMap<String, Map<String, String>>();
	...
	public final static Map<String, String> sxdsMap = new HashMap<String, String>();
	/**
	 * 北单串关组合
	 */
	...
	static {
		...
		//add by cheng.chen 2017-10-21  彩果格式
		bfMap.put("10", "1:0");
		bfMap.put("20", "2:0");
		bfMap.put("21", "2:1");
		bfMap.put("30", "3:0");
		...
		//add by cheng.chen 17.10.25 添加北单 上下单双
		sxdsMap.put("1", "上单");
		sxdsMap.put("2", "上双");
		sxdsMap.put("3", "下单");
		sxdsMap.put("4", "下双");
		...
		//add by cheng.chen 17.10.19 用于数据转换
		fbPlayWay.put("S", spfMap);
		fbPlayWay.put("R", rqspfMap);
		fbPlayWay.put("Q", bfMap);
		fbPlayWay.put("B", bqcMap);
		fbPlayWay.put("D", sxdsMap);
		fbPlayWay.put("W", sfMap);
		
		bbPlayWay.put("S", spfMap);
		bbPlayWay.put("R", rqspfMap);
		bbPlayWay.put("C", sfcMap);
		bbPlayWay.put("D", dxfMap);
	}
}
