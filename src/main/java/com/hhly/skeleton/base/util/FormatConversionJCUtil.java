...
//				return content.substring(content.indexOf(SymbolConstants.DOUBLE_SLASH+pre)+1, content.indexOf(SymbolConstants.DOUBLE_SLASH+suf));
	 ...
	 * @return 让分值
	 */
	public static String letNumBetContentSubstring (String matchBet){
		return stringSubstringToString(matchBet, SymbolConstants.MIDDLE_PARENTHESES_LEFT,  SymbolConstants.MIDDLE_PARENTHESES_RIGHT, false);
	}	
