...
public class StringUtil extends StringUtils {
	...
	*/
	...
	public static boolean isRepeat(String[] strs){
		if(!ObjectUtil.isBlank(strs)){
			Set<String> setRepeat = new HashSet<String>();
			for(int i = 0; i < strs.length; i++){
				setRepeat.add(strs[i]);
			}
			if(setRepeat.size() != strs.length){
				return true;
			}
		}
		return false;
	...
	*/
	...
	public static String encrptionNickname(String nickName) {
        ...
        if (nickname.length()<= 4) {
            ...
            String str = nickname.substring(0,4)+"...";
            return str;
        }
    }
	
	/**  
	* 方法说明: 带加减符号，保留2位小数的金额
	* @auth: xiongJinGang
	* @param amount 金额
	* @param symbol +/-符号
	* @time: 2017年11月11日 上午10:08:06
	* @return: String 
	*/
	 ...
	 * @return
	 */
	public static List<String> findStr(String content,String patter){
     ...
     * 保留num的位数, 0 代表前面补充0,num 代表长度为4,d 代表参数为正数型
     * @param code
     * @return
     */
