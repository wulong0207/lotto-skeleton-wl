...
import com.hhly.skeleton.base.issue.itf.ICatchIssue;
...
public class NewTypeBO extends BaseBO{
	 ...
	 * 抓取第三方信息接口
	 */
	ICatchIssue catchIssue;
	/**
	 * 获取同步第三方信息
	 * @author jiangwei
	 * @Version 1.0
	 * @CreatDate 2017年4月13日 下午5:28:52
	 * @param lastIssueCode
	 * @return
	 */
    public CatchIssueBO getNewIssueBO(String lastIssueCode){
    	return catchIssue.getIssue(lastIssueCode, lotteryCode);
    }
	
	public ICatchIssue getCatchIssue() {
		return catchIssue;
	}

	public void setCatchIssue(ICatchIssue catchIssue) {
		this.catchIssue = catchIssue;
	}
