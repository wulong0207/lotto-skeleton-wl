...
public class UserConstants {
     ...
     * 微博登录常量配置
     */
    public final static String WEIBO_CLIENT_ID = PropertyUtil.getPropertyValue("application.properties", "weibo_client_id");
    
    public final static String WEIBO_CLIENT_SECRET = PropertyUtil.getPropertyValue("application.properties", "weibo_client_secret");   

    public final static String WEIBO_GRANT_TYPE = PropertyUtil.getPropertyValue("application.properties", "weibo_grant_type");
    
    public final static String WEIBO_ACCESS_TOKEN_URL = PropertyUtil.getPropertyValue("application.properties", "weibo_access_token_url");
    
    public final static String WEIBO_USER_INFO_URL = PropertyUtil.getPropertyValue("application.properties", "weibo_user_info_url");
