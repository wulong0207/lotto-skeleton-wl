...
public class MessageCodeConstants {
	 ...
	 * 字符长度超最大限制
	 */
	public static final String STRING_LENGTH_LIMIT = "40237";
	/**
	 * 认购密码不符合规范
	 */
	public static final String APPLY_PASSWORD_ILLEGAL_SERVICE = "40238";
	/**
	 * 彩种最低投注金额、投注倍数限制
	 */
	public static final String LOTTERY_MIN_BET_LIMIT_SERVICE = "40239";
	/**
	 * 竞技彩限号
	 */
	public static final String LOTTERY_LIMIT_SERVICE = "40240";
	/**
	 * 渠道为空
	 */
	 ...
	 * 系统异常，支付失败
	 */
	public static final String PAY_FAIL_ERROR_SERVICE = "40532";
	/**
	 * 红包金额错误
	 */
	 ...
	 *订单已支付
	 */
	public static final String ORDER_HAD_PAY = "44590";
	 ...
	 * qq功能暂时不能用
	 */
	public static final String QQ_CAN_NOT_LOGIN = "40203";
	...
	/**
	 * 等待支付
	 * 2014-09-20 16:41 发起超级大乐透代购方案。出票截止时间09-20 19:55
	 */
	public static final String SUBMIT_ORDER = "40801";
	/**
	 * 支付失败
	 * 2014-09-20 16:41 订单支付失败，如有疑问请联系客服。
	 */
	public static final String PAY_FAIL = "40802";

	/**
	 * 未支付已过期
	 * 2014-09-20 16:41 订单未支付过期。
	 */
	public static final String NO_PAY_OVERDUE = "40803";

	/**
	 * 2014-11-09 20:45 方案正在等待出票。方案官方截止出票时间11-09 20:45:09
	 * 支付成功
	 */
	public static final String PAY_SUCCESS_IN_TIME = "40804";

	/**
	 * 2014-11-09 20:45 方案官方截止出票时间11-09 20:45:09
	 * 出票中
	 */
	...
	/**
	 * 2014-11-09 20:45 中心于19日9点开始出票。方案官方截止出票时间11-09 20:45:09
	 * 支付成功,不在出票时间内
	 */
	...
	/**
	 * 首冲活动异常，存在多个活动,请将问题反馈给客服！
	 */
	public static final String FIRST_REC_ACTIVITY_TOO_MORE = "40959";
	/**
	 * 用户注册的渠道不参与活动！
	 */
	public static final String FIRST_REC_CLINNAL_NOT_JOIN = "40960";
	...
	*/
	...
	/**
	 * 您已有多个用户账号参与活动,感谢您的参与!您还可以参与世界杯购彩!
	 */
	public static final String ACTIVITY_CHP_HAS_MORE_NAME = "41809";
	/**********************************帮助中心*********************************************/
	/**
	 * 您已评价过该文章，请勿重复评价！
	 */
	 ...
	 * 合买信息为空！
	 */
	public static final String NO_EXIST_ORDER_GROUP_INFO = "40714";

	/**
	 * 未支付或者已满员提示
	 */
	public static final String CAN_NOT_FLOW = "40715";

	/**********************************合买*********************************************/
	/**
	 * 合买订单不存在
	 */
	public static final String ORDER_GROUP_DETAIL_IS_NULL = "45100";
	/**
	 * 合买订单购买失败
	 */
	public static final String ORDER_GROUP_BUY_FAIL = "45101";
	/**
	 * 合买订单已满员
	 */
	public static final String ORDER_GROUP_HAD_FULL = "45102";
	/**
	 * 支付金额大于合买订单剩余认购金额
	 */
	public static final String ORDER_GROUP_PAY_MONEY_FAIL = "45103";
	/**
	 * 交易记录的金额与保底金额不一致
	 */
	public static final String ORDER_GROUP_MONEY_ERROR = "45104";
	/**
	 * 合买订单退款失败
	 */
	public static final String ORDER_GROUP_REFUND_ERROR = "45105";
	/**
	 * 合买订单状态错误
	 */
	public static final String ORDER_GROUP_STATUS_ERROR = "45106";
	/**
	 *参与 合买金额错误
	 */
	public static final String ORDER_GROUP_PAY_AMOUNT_ERROR = "45107";
	/**
	 *合买进度小于90%
	 */
	public static final String ORDER_GROUP_PAY_PROGRESS_ERROR = "45108";

	public static final String ORDER_GROUP_ORDER_CODE_IS_NULL = "45109";

	public static final String ORDER_GROUP_NOT_SATISFY_ABORTION_CONDITION = "45110";

	public static final String ORDER_GROUP_SITE_GUARANTEE_EXCEPTION = "45111";
	/**
	 *退保底金额失败
	 */
	public static final String ORDER_GROUP_GUARANTEE_AMOUNT_REFUND_ERROR = "45112";

	/**
	 * 合买认购码错误
	 */
	public static final String ORDER_GROUP_WRONG_APPLY_CODE = "45116";

	/**
	 * 没有合买用户相关统计信息
	 */
	public static final String ORDER_GROUP_USER_NOT_EXIST = "45117";
	/**
	 * 不能重复执行网站保底
	 */
	public static final String ORDER_GROUP_WEB_GUARANTEE_REPEAT = "45118";
	
	/**
	 * 最低返奖率须大于145%
	 */
	public static final String ORDER_MIN_PRIZE_RATE = "45119";
	
	/**
	 * 多选时2个推荐项的赔率必须都大于2.45
	 */
	public static final String BET_MORE_MIN_RATE = "45120";
	
	/**
	 * 单选时的赔率必须都大于1.45
	 */
	public static final String BET_ONE_MIN_RATE = "45121";
	
	/**
	 * 今天推荐方案数已达限定值，请明天继续推荐
	 */
	public static final String ORDER_MAX_COUNT = "45122";
	
	/**
	 * 相同串关场次不能重复推荐
	 */
	public static final String ORDER_NOT_REPEAT = "45123";

	/**
	 * 您还不是专家，请先进行推单资格认证
	 */
	public static final String RCMD_NO_EXPERTS="45124";

	/**
	 * 最多选择2场比赛
	 */
	public static final String MOST_TWO_MATCH="45125";

	/**
	 * 让球和不让球不能混合
	 */
    public static final String MIX_RANGQIU_NO_RANG_QIU="45126";

	/**
	 * 最多选择1场比赛
	 */
	public static final String MOST_ONE_MATCH="45127";

	/**
	 * 不能重复推荐同场比赛
	 */
	public static final String CANT_SAME_MATCH="45128";

	/**
	 * 推荐场次已过销售截止时间
	 */
	public static final String TIME_OUT="45129";

	/**
	 * 单关不能全包
	 */
	public static final String BET_ALL="45130";


	/**
	 * 已经是分析师，不需要再次申请
	 */
	public static final String IS_FENXISHI="45131";
	
	/**
	 * 内容格式不合法
	 */
	public static final String BET_CONTENT_ERR="45132";
