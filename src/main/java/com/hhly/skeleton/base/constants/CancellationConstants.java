...
public class CancellationConstants {
	...
	public enum OrderTypeEnum {
		INDENTORDER((short) 1, "代购订单"), ADDEDORDER((short) 2, "追号订单"),ORDERGROUP((short)3,"合买订单");
		private Short key;
	...
	public enum BuyTogetherRefundTypeEnum{
		NOTFULL((short)1,"合买订单未满员"),SITEGUARANTEE((short)2,"网站保底"),REFUNDTOPROVIDER((short)3,"退款给发起人"),CMSREFUND((short)4,"系统合买退款");
		private Short key;
		private String value;

		BuyTogetherRefundTypeEnum(Short key, String value) {
			this.key = key;
			this.value = value;
		}
	...
	public enum RefundTypeEnum {
		WINNINGSTOPREFUND((short) 1, "中奖停追退款"), 
		CURISSUEREFUND((short) 2, "单期撤单退款"), 
		USERCANCELREFUND((short) 3, "用户撤单退款"),
		MULTIISSUEREFUND((short) 4, "多期撤单退款");
		private Short key;
		private String value;
	...
	public enum RefundTagetEnum {
		REFUNDTOHANDSEL((short) 1, "退款至彩金"), REFUNDTO80BALANCE((short) 2, "退款至余额80%"), REFUNDTO20BALANCE((short) 3, "退款至余额20%"), REFUNDTOOLDPAYMENT((short) 4, "原支付方式退回");
		private Short key;
		private String value;
	...
	public enum OrderAddIssueStatusEnum {
		ADDSUCCESS((short) 1, "追号成功"), ADDFAIL((short) 2, "追号失败"), CANCELLATIONSYSTEM((short) 3, "系统撤单"), CANCELLATIONUSER((short) 4, "用户撤单"), WAITINGADD((short) 5, "等待追号"), INCANCELLATION((short) 6,
		...
		public static CancellationConstants.OrderAddIssueStatusEnum getEnum(Short key) {
			if (!ObjectUtil.isBlank(key)) {
				for (CancellationConstants.OrderAddIssueStatusEnum orderStatusEnum : CancellationConstants.OrderAddIssueStatusEnum.values()) {
	...
	public enum OrderAddStatusEnum {
		INADD((short) 1, "追号中"), WINNINGSTOPADD((short) 2, "中奖停追"), ADDEND((short) 3, "追号结束"), CANCELLATIONSYSTEM((short) 4, "用户撤单"), CANCELLATIONUSER((short) 5, "系统撤单");
		private Short key;
		private String value;
	...
	public enum OrderStatusEnum {
		WAITINGUPLOAD((short) 1, "待上传"), PENDINGTICKET((short) 2, "待拆票"), BILLOFFARE((short) 3, "拆票中"), TICKETPAYABLE((short) 4, "待出票"), DRAWNIN((short) 5, "出票中"), DRAWN((short) 6, "已出票"), DRAWNERROR((short) 7,
				"出票失败"), CANCELLATIONOK((short) 8, "已撤单"), INCANCELLATION((short) 10, "撤单中");
		private Short key;
		private String value;
	...
	public enum OrderWinningStatusEnum {
		...
		public static CancellationConstants.OrderWinningStatusEnum getEnum(Short key) {
			if (!ObjectUtil.isBlank(key)) {
				for (CancellationConstants.OrderWinningStatusEnum winningStatusEnum : CancellationConstants.OrderWinningStatusEnum.values()) {
