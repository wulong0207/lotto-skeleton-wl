 ...
 * @compay 益彩网络科技有限公司
 */
public class SingleUploadLogMsgModel {
	/**
	 * 用户编号
	 */
	...
	public String toString() {
		return "SingleUploadLogMsgModel [userId=" + userId + ", lotteryCode=" + lotteryCode + ", lotteryChildCode="
				+ lotteryChildCode + ", fileUrl=" + fileUrl + ", uploadResult=" + uploadResult + ", sessionType="
				+ sessionType + ", operationType=" + operationType + ", shiftType=" + shiftType + ", shift=" + shift
				+ ", fileFormat=" + fileFormat + ", remark=" + remark + "]";
	}
