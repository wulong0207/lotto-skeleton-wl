...
public class OrderEnum {
	...
	public enum NumberCode {
		...
		CDKEY_COUNPN("R", "红包兑换码"), CDKEY_INTEGRAL("J", "积分兑换码"),ORDER_GROUP_BUYCODE("OG","合买认购编号"),ORDER_RCMD("OR","合买认购编号"),;
	...
	public enum OrderUnityStatus {
		...
		//
		BET_FAIL(5, "投注失败"), BET_SUCCESS(6, "投注成功") ,RECRUIT(7,"招募中"),ABORTION(8,"合买流产"),CANCEL_ORDER(9,"合买撤单");
	...
	public enum OrderFlowUnityStatus {
		...
		RECRUIT(13,"招募中"),FULL_PERSON(14,"已满员"),ABORTION(15,"合买流产"),CANCEL_ORDER(16,"合买撤单");
		private Integer value;
		private String desc;
	 ...
	 * 合买状态
	 */
	public enum GRPBuyStatus {

		RECRUIT("招募中", (short) 1), FULL_PERSON("已满员", (short) 2), ABORTION("合买流产", (short) 3),CANCEL_ORDER("合买撤单", (short) 4);
		...
		GRPBuyStatus(String desc, short value) {
			this.desc = desc;
			this.value = value;
		}
