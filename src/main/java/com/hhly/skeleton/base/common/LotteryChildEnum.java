...
public class LotteryChildEnum {
	...
	public enum LotteryChild {
		 ...
		 * 幸运农场(重庆快乐10分)
		 */
		CQKL10_ST(22201,"前一数投", "前一数投"),
		CQKL10_HT(22202,"前一红投", "前一红投"),
		CQKL10_R2(22203,"任选二", "任选二"),
		CQKL10_G2(22204,"选二连组", "选二连组"),
		CQKL10_D2(22205,"选二连直", "选二连直"),
		CQKL10_R3(22206,"任选三", "任选三"),
		CQKL10_G3(22207,"选三前组", "选三前组"),
		CQKL10_D3(22208,"选三前直", "选三前直"),
		CQKL10_R4(22209,"任选四", "任选四"),
		CQKL10_R5(22210,"任选五", "任选五"),
		
		/**
		 * 竞彩足球
		 */
		/**混投*/
		ID_FHT(30001, "竞彩足球混投", "混投"),
		/**胜平负*/
		ID_JCZQ(30002, "竞彩足球胜平负", "胜平负"),
		/**让胜平负*/
		ID_RQS(30003, "竞彩足球让球胜平负", "让球胜平负"),
		/**比分*/
		ID_FBF(30004, "竞彩足球比分", "比分"),
		/**总进球*/
		ID_FZJQ(30005, "竞彩足球总进球", "总进球"),
		/**半全场*/
		ID_FBCQ(30006, "竞彩足球半全场", "半全场"),
		
        /**
         * 竞彩篮球
         */
		/*竞彩篮球胜负*/
		ID_JCLQ_SF(30101, "竞彩篮球胜负", "胜负"),
		/*竞彩篮球让分*/
		ID_JCLQ_RF(30102, "竞彩篮球让分胜负", "让分胜负"),
		/*竞彩篮球大小分*/
		ID_JCLQ_DXF(30103, "竞彩篮球大小分", "大小分"),
		/*竞彩篮球胜分差*/
		ID_JCLQ_SFC(30104, "竞彩篮球胜分差", "胜分差"),
		/**混投*/
		ID_JCLQ_HHGG(30105, "竞彩篮球混投", "混投"),

		/***老足彩9场胜平负普通投注*/
		ID_NINE_BET(30501, "9场胜平负普通投注", "普通投注"),
		/***老足彩9场胜平负胆拖投注*/
		ID_NINE_BANKERS_BET(30502, "9场胜平负胆拖投注", "胆拖投注"),

		/**
		 * 北单
		 */
		/**   让球胜平负*/
		ID_BD_RQS(30601, "北单让球胜平负", "胜平负"),
		/** 上下单双 */
		ID_BD_SXDX(30602, "北单上下单双", "上下单双"),
		/**   总进球 */
		ID_BD_FZJQ(30603, "北单总进球", "总进球"),
		/**   比分 */
		ID_BD_FBF(30604, "北单比分", "比分"),
		/**   半全场 */
		ID_BD_FBCQ(30605, "北单半全场", "半全场"),
		
		/**十四场*/
		ID_FOURTEEN(30401, "十四场普通投注", "普通投注"),
		
		/** 胜负过关 */
		ID_SFGG_PT(30701, "胜负过关普通投注", "胜负过关普通投注"),

		/** 胜负过关 */
		CHP(30801, "冠军游戏普通投注", "冠军游戏普通投注"),


		/** 胜负过关 */
		FNL(30901, "冠亚军游戏普通投注", "冠亚军游戏普通投注");
		...
		LotteryChild(int value, String desc, String shortName) {
			this(value, desc);
		...
		public static LotteryChild getByValue(int value){
			for (LotteryChild child : LotteryChild.values()) {
