...
public class PokerOmitBO extends HighOmitBaseBO {

	/**
	 * 同花
	 */
	@Assemble(regex={"^pt[1-4]$"},include={"pt"})
	private ArrayList<Object> th;
	/**
	 * 顺子
	 */
	@Assemble(regex={"^px\\w{3,4}$"},include={"px"})
	private ArrayList<Object> sz;
	/**
	 * 对子
	 */
	@Assemble(regex={"^pd\\w{1,2}$"},include={"pd"})
	private ArrayList<Object> dz;
	/**
	 * 豹子
	 */
	@Assemble(regex={"^pb\\w{1,2}$"},include={"pb"})
	private ArrayList<Object> bz;
	/**
	 * 任选
	 */
	@Assemble(regex={"^pa|p[2-9]|p10|pj|pq|pk$"})
	private ArrayList<Object> rx;
    /** 
     * A的遗漏
     */
    private Integer pa;
    ...
    private Integer pbk;
    /**
     * 0.散牌,1.同花顺,2.同花,3.顺子,4.对子,5.豹子
     */
	...
	public ArrayList<Object> getTh() {
		return th;
	}
	public void setTh(ArrayList<Object> th) {
		this.th = th;
	}
	public ArrayList<Object> getSz() {
		return sz;
	}
	public void setSz(ArrayList<Object> sz) {
		this.sz = sz;
	}
	public ArrayList<Object> getDz() {
		return dz;
	}
	public void setDz(ArrayList<Object> dz) {
		this.dz = dz;
	}
	public ArrayList<Object> getBz() {
		return bz;
	}
	public void setBz(ArrayList<Object> bz) {
		this.bz = bz;
	}
	public ArrayList<Object> getRx() {
		return rx;
	}
	public void setRx(ArrayList<Object> rx) {
		this.rx = rx;
	}
