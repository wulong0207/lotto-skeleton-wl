...
public class RcmdInfoVO extends BaseVO {
    /**
     * 
     */
    private Integer id;
     ...
     * 方案内容
     */
    List<RcmdDetailVO> rcmdDetailList;
	...
	public List<RcmdDetailVO> getRcmdDetailList() {
		return rcmdDetailList;
	}

	public void setRcmdDetailList(List<RcmdDetailVO> rcmdDetailList) {
		this.rcmdDetailList = rcmdDetailList;
	}
