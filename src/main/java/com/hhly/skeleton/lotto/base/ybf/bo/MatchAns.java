 ...
 * @date 2015-7-24
 */
public class MatchAns extends BaseBO implements Cloneable {
...
//    public void tranTotalScore() {
//
//        if (totalScore == null || totalScore.indexOf("/") != -1) {
//            return;
//        }
//        BigDecimal[] result = new BigDecimal(totalScore).divideAndRemainder(half);
//        if (result[1].floatValue() != 0) {
//            setTotalScore(ToolUtil.trimNumber(new BigDecimal(totalScore).subtract(this.quarter).toString()) + "/" + ToolUtil.trimNumber(new BigDecimal(totalScore).add(this.quarter).toString()));
//        } else {
//            setTotalScore(totalScore.toString());
//        }
//    }
    ...
    public static BigDecimal getQuarter() {
        return quarter;
    }

    public static BigDecimal getHalf() {
        return half;
    }
    ...
    public MatchAns clone() {
        try {
            return (MatchAns) super.clone();
