...
public class TicketInfoBO extends BaseBO{
	private static final long serialVersionUID = -7892692452729598655L;
	/**
	 * 本地票号
	 */
	private Long id;
	 ...
	 */
	@JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss", timezone = "GMT+8")
	private Date channelAllocationSendTime;

	// 总条数
	private Integer count;
	
	private O2OTicketBO o2oTicketBO;
	...
	/**
	 * @return the channelAllocationSendTime
	 */
	public Date getChannelAllocationSendTime() {
		return channelAllocationSendTime;
	}

	/**
	 * @param channelAllocationSendTime the channelAllocationSendTime to set
	 */
	public void setChannelAllocationSendTime(Date channelAllocationSendTime) {
		this.channelAllocationSendTime = channelAllocationSendTime;
	}
	...
	/**
	 * @return the o2oTicketBO
	 */
	public O2OTicketBO getO2oTicketBO() {
		return o2oTicketBO;
	}

	/**
	 * @param o2oTicketBO the o2oTicketBO to set
	 */
	public void setO2oTicketBO(O2OTicketBO o2oTicketBO) {
		this.o2oTicketBO = o2oTicketBO;
	}
