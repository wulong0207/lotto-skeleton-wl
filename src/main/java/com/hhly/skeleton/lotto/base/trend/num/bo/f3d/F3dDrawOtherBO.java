...
/**
 * @desc 福彩3d开奖其它信息(eg:计算的和值、跨度、大小、奇偶等) 注：用于彩种首页最新开奖信息的补充信息
 * @author huangb
 * @date 2017年6月26日
 * @company 益彩网络
 * @version v1.0
 */
public class F3dDrawOtherBO extends DrawOtherBO {

	private static final long serialVersionUID = -3136713424456220712L;
	/**
	 * 开奖号：和值
	 */
	private Integer sum;
	...
	private Integer bs;
	/**
	 * 开奖号：类型；eg:福彩3d开奖号类型（1-豹子;2-组三;3-组六）
	 */
