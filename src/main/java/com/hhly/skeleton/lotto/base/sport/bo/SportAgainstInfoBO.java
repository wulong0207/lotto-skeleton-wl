...
public class SportAgainstInfoBO extends BaseBO {
    ...
    public String toString() {
        return new ToStringBuilder(this)
                ...
                .append("matchAnalysisUrl", matchAnalysisUrl)
                .append("matchInfoUrl", matchInfoUrl)
                .append("isRecommend", isRecommend)
                .append("matchLabelColor", matchLabelColor)
                ...
                .append("isNeutral", isNeutral)
                .append("stadium", stadium)
                ...
                .append("oldMatchIndex", oldMatchIndex)
                .toString();
    }
