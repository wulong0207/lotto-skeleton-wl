...
public class OperateActivityConfigVO extends PageVO {
     ...
     * 活动配置规则集合
     */
    private List<?> operateActivityRuleVOList;

    /**
     * 赛事加奖规则集合
     */
    private List<?> operateActivitySportRuleVOList;
    
    /**
     * 追号规则集合
     */
    private List<?> operateActivityAddedVOList;

    /**
     * 送彩票规则集合
     */
    private List<?> operateActivityLottoRuleVOList;
    /**
     * 规则id集合
     */
    private List<Integer> ruleIds;
    
    private List<Integer> lottoRuleIds;
    ...
    private OperateActivityAddedVO operateActivityAddedVO;
    /**
     * 活动每日配送次数上限
     */
	...
	public List<?> getOperateActivityRuleVOList() {
		return operateActivityRuleVOList;
	}

	public void setOperateActivityRuleVOList(List<?> operateActivityRuleVOList) {
		this.operateActivityRuleVOList = operateActivityRuleVOList;
	}

    public List<?> getOperateActivitySportRuleVOList() {
        return operateActivitySportRuleVOList;
    }

    public void setOperateActivitySportRuleVOList(List<?> operateActivitySportRuleVOList) {
        this.operateActivitySportRuleVOList = operateActivitySportRuleVOList;
    }
    
    public List<?> getOperateActivityLottoRuleVOList() {
		return operateActivityLottoRuleVOList;
	}

	public void setOperateActivityLottoRuleVOList(List<?> operateActivityLottoRuleVOList) {
		this.operateActivityLottoRuleVOList = operateActivityLottoRuleVOList;
	}
	...
	public List<Integer> getLottoRuleIds() {
		return lottoRuleIds;
	}

	public void setLottoRuleIds(List<Integer> lottoRuleIds) {
		this.lottoRuleIds = lottoRuleIds;
	}
	...
	public List<?> getOperateActivityAddedVOList() {
		return operateActivityAddedVOList;
	}

	public void setOperateActivityAddedVOList(List<?> operateActivityAddedVOList) {
		this.operateActivityAddedVOList = operateActivityAddedVOList;
	}

	public OperateActivityAddedVO getOperateActivityAddedVO() {
		return operateActivityAddedVO;
	}

	public void setOperateActivityAddedVO(OperateActivityAddedVO operateActivityAddedVO) {
		this.operateActivityAddedVO = operateActivityAddedVO;
	}
