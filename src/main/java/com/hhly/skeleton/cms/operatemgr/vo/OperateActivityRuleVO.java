...
public class OperateActivityRuleVO extends PageVO {
    /**
     * 规则主键id
     */
    private Integer id;
     ...
     * 活动详情倍数与减免金额List
     */
    private List<OperateActivityBetVO> operateActivityBetVOList;
    ...
    public List<OperateActivityBetVO> getOperateActivityBetVOList() {
        return operateActivityBetVOList;
    }

    public void setOperateActivityBetVOList(List<OperateActivityBetVO> operateActivityBetVOList) {
        this.operateActivityBetVOList = operateActivityBetVOList;
    }
}