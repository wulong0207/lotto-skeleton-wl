...
public class OperateActivityRechargeVO extends BaseVO {
    /**
     * 
     */
    private Integer id;
     ...
     * 优惠券模板信息
     */
    private List<OperateCouponTempVO> couponTemp;
	...
	public List<OperateCouponTempVO> getCouponTemp() {
		return couponTemp;
	}

	public void setCouponTemp(List<OperateCouponTempVO> couponTemp) {
